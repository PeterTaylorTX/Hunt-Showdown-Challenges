...
namespace Twitch
{
    public class Config
    {
        ...
        /// </summary>
        private static string appDataRoot { get; set; } = $"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\\Hunt Showdown Challenges";
        /// <summary>
        /// The config file location
        /// </summary>
        ...
        /// </summary>
        static string authScopes = "channel:bot+user:write:chat+chat:edit+chat:read+moderator:manage:banned_users+moderation:read+moderator:manage:blocked_terms+user:read:moderated_channels+channel:moderate+user:read:moderated_channels+channel:read:redemptions";
        /// <summary>
        ...
        /// The current user
        /// </summary>
        public Twitch.Models.Users.Channels.Channel Channel { get; set; } = new();
        /// <summary>
        /// OAuth Token
        /// </summary>
        ...
        /// <summary>
        /// Override the Twitch Scopes
        /// </summary>
        /// <param name="scope">The new scope</param>
        public void OverrideScope(string scope)
        {
            authScopes = scope;
        }
